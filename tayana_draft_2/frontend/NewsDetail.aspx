<%@ Page Title="" Language="C#" MasterPageFile="~/frontend/front.Master" AutoEventWireup="true" CodeBehind="NewsDetail.aspx.cs" Inherits="tayana_draft_2.frontend.WebForm9" %>
    ...
    <div class="conbg">
        ...
        <div class="right">
            <div class="right1">
                ...
                <!--------------------------------內容開始---------------------------------------------------->
                <div class="box3">
                    <h4><a href="News.aspx?id=<%#Eval("id") %>">
