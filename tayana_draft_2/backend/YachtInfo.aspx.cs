...
namespace tayana_draft_2.backend
{
    public partial class WebForm2 : System.Web.UI.Page
    {
        ...
        //protected void SubToUpload(object sender, EventArgs e)
        //{
        ...
        //    if (YachtUpload.HasFile)
        //    {
        //        foreach (var postedFile in YachtUpload.PostedFiles)
        //        {
        //            string fileName = Path.GetFileName(postedFile.FileName);
        //            postedFile.SaveAs(Server.MapPath("allFiles/") + fileName);

        //            string query = "INSERT INTO Img (Img) VALUES(@Img)";
        //            conn.Open();
        ...
        //        }
        //        lblErrorMsg.Text = "successfully uploaded";
        ...
        protected void GridView1_OnRowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            string sq = $"DELETE FROM YachtInfo WHERE id=@id";
