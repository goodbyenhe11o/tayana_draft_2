<%@ Page Title="" Language="C#" MasterPageFile="~/backend/back.Master" AutoEventWireup="true" CodeBehind="Profile.aspx.cs" Inherits="tayana_draft_2.backend.WebForm17" %>
    ...
    <div class="nes-container is-rounded content-wrapper">
        ...
        <div class="left-part">
            ...
            <div class="nes-container is-rounded">
                ...
                <asp:Button ID="btnConfirmUpload" runat="server" Text="CONFIRM UPDATE" class="nes-btn is-success" OnClick="btnConfirmUpload_OnClick" style="margin-left: -200px; margin-top: 20px;" />
        ...
        <p style="font-size: 20px; text-decoration: underline ">UPDATE YOUR USER DETAILS</p>
            ...
            <asp:Button ID="btnUpdateDetails" runat="server" Text="UPDATE DETAILS" class="nes-btn is-success"  OnClick="btnUpdateDetails_OnClick"  style="margin-left: 180px; margin-top: 20px;"/>
        </div>
